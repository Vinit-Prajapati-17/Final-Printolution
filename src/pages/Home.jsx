        ...
        <section className="highlights-banner-section">
          <div className="container">
            <div className="banner-top">
              <img src={`${import.meta.env.BASE_URL}img/Web Banner.gif`} alt="Printolution Services Banner" className="banner-img" />
            </div>
        ...
        <section className="our-clients">
            ...
            <div className="clients-track clients-track-1">
              {[...Array(18)].map((_, i) => (
                <div key={i} className="client-logo">
                  <img src={`${import.meta.env.BASE_URL}OUR CLIENT/${(i % 9) + 1}.png`} alt={`Client ${(i % 9) + 1}`} />
                </div>
              ))}
            </div>
          </div>
          <div className="clients-marquee">
            <div className="clients-track clients-track-2">
              {[...Array(16)].map((_, i) => (
                <div key={i} className="client-logo">
                  <img src={`${import.meta.env.BASE_URL}OUR CLIENT/${(i % 8) + 10}.png`} alt={`Client ${(i % 8) + 10}`} />
                </div>
              ))}
            </div>
          </div>
